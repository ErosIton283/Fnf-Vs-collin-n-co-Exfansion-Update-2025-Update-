...
{
	public static var psychEngineVersion:String = '3.0.0 2025 Update'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Collin n co v" + psychEngineVersion, 12);
